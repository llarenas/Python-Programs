...
AutoLinux — Written by Ronel Llarenas.
...
def instalars():
  ...
  if opcao == "8":
    ...
    saida = input(space2 + "         " + RED+"Press ENTER to return to menu.\n")
    if saida == "":
      instalar()
      instalars()
  if opcao == "7":
...
def salvar_web():
  ...
  banner_central()
  try:
    web = input(GREEN+"                     Enter the page that will save.\n                     > ")
  except EOFError:
	  print("\n\nBye")
	  sys.exit(0)
  print ("\n")
  if web == "":
    ...
    fname = input("       What is the name of the file you want to save? in: index.html\n                           > ")
    if fname == "":
      logado()
    else:
      print ("\n\n")
...
def banner_central():
  ...
  print ("                                       `----*")
  print ("          ---------------------------------------------------------------")
  print ("          |                    AutoLinux - by Ronel Llarenas                  |")
  print ("          ---------------------------------------------------------------")
...
def contato():
  ...
  banner_central2()
  print (space2 + "               " + "")
  saida = input(space2 + "          " + RED+"Pressione ENTER  Menu.\n")
  if saida == "":
    logado()
...
def ipresolver():
  os.system("clear")
  banner_central()
  domain = input(WHITE+"                    Enter a domain: ") # www.domain.com
  ...
  saida = input(RED+"                  Press ENTER to return to menu.\n")
  if saida == "":
    logado()
